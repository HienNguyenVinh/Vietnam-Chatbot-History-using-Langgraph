...
def vector_search_chroma(
    ...
    if query_embedding is None:
        ...
        if hasattr(embedder, "encode"):
            q_emb = embedder.encode(query, convert_to_numpy=True, prompt_name="Retrieval-query")
        else:
...
embedder = SentenceTransformer("google/embeddinggemma-300M", trust_remote_code=True)
